...
export default function LeaderboardPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-3xl space-y-6 px-6 py-16">
      ...
      <p className="text-sm text-gray-500">Each typist’s best 60-second Test result, ranked by adjusted WPM (top 50).</p>
      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto rounded-lg border border-gray-500">
          <table className="w-full text-left text-sm">
            <caption className="sr-only">Best 60-second Test result for each typist</caption>
